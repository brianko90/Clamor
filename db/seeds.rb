...
file = open('https://clamor-aa-dev.s3.us-west-1.amazonaws.com/Pastel-Gray.png')
server1.serverpic.attach(io: file, filename: 'Pastel-Gray.png')
server2 = Server.create({name: 'Anime Group', owner_id: user5.id, public: true})
file = open('https://clamor-aa-dev.s3.us-west-1.amazonaws.com/Pastel-Gray.png')
server2.serverpic.attach(io: file, filename: 'Pastel-Gray.png')
server3 = Server.create({name: "LoL", owner_id: user3.id, public: true})
file = open('https://clamor-aa-dev.s3.us-west-1.amazonaws.com/Pastel-Gray.png')
server3.serverpic.attach(io: file, filename: 'Pastel-Gray.png')
server4 = Server.create({name: "cars", owner_id: user7.id, public: true})
file = open('https://clamor-aa-dev.s3.us-west-1.amazonaws.com/Pastel-Gray.png')
server4.serverpic.attach(io: file, filename: 'Pastel-Gray.png')
server5 = Server.create({name: 'valk fan club', owner_id: user4.id, public: true})
file = open('https://clamor-aa-dev.s3.us-west-1.amazonaws.com/Pastel-Gray.png')
server5.serverpic.attach(io: file, filename: 'Pastel-Gray.png')
server6 = Server.create({name: 'Coding 101', owner_id: user2.id, public: true})
file = open('https://clamor-aa-dev.s3.us-west-1.amazonaws.com/Pastel-Gray.png')
server6.serverpic.attach(io: file, filename: 'Pastel-Gray.png')
